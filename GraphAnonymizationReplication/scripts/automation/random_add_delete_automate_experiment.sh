...
dataset=$1
experiment_name_prefix="random_add_delete"
...
do
    ...
    python scripts/random/random_add_delete.py $i >> output.txt 
...
python compute_stats.py $experiment_name"_non_anon" $dataset >> output.txt
